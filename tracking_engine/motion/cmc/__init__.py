...
from tracking_engine.motion.cmc.base_cmc import BaseCMC
...
_CMC_REGISTRY: Mapping[str, Callable[[], Type[BaseCMC]]] = {
    "ecc": _LazyLoader("tracking_engine.motion.cmc.ecc", "ECC"),
    "orb": _LazyLoader("tracking_engine.motion.cmc.orb", "ORB"),
    "sof": _LazyLoader("tracking_engine.motion.cmc.sof", "SOF"),
    "sift": _LazyLoader("tracking_engine.motion.cmc.sift", "SIFT"),
}
