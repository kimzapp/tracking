...
if (_local_root / "pyproject.toml").is_file() and (_local_root / "tracking_engine").is_dir():
    ROOT = _local_root

DATA = ROOT / "data"
TOML = ROOT / "pyproject.toml"

TRACKING_ENGINE = ROOT / "tracking_engine"
CONFIGS    = TRACKING_ENGINE / "configs"
